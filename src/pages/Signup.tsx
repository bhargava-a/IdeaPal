...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 to-secondary/10">
      <form onSubmit={handleSignup} className="bg-white/90 shadow-xl rounded-2xl p-8 w-full max-w-md animate-fade-in">
        <div className="flex flex-col items-center mb-6">
          <Logo className="w-16 h-16 mb-2" />
          <h2 className="text-2xl font-bold mb-1 text-primary">Create Account</h2>
        ...
        <div className="mt-4 text-center text-gray-600">
          ...
          <Link to="/login" className="text-primary underline font-medium">Login</Link>
        </div>
      </form>
    </div>
  );
